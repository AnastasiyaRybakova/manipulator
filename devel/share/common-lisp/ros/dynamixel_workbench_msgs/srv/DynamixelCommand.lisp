...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DynamixelCommand-response>)))
  ...
  (cl:format cl:nil "~%bool comm_result~%~%~%# # It is Served by 'single_dynamixel_monitor' node~%# # This message is used to send command to dynamixel~%~%# string command~%~%# string addr_name~%# int64 value~%~%# ---~%~%# bool comm_result~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DynamixelCommand-response)))
  "Returns full string definition for message of type 'DynamixelCommand-response"
  (cl:format cl:nil "~%bool comm_result~%~%~%# # It is Served by 'single_dynamixel_monitor' node~%# # This message is used to send command to dynamixel~%~%# string command~%~%# string addr_name~%# int64 value~%~%# ---~%~%# bool comm_result~%~%~%~%"))
